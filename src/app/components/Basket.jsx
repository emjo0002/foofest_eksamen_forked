      ...
      >
        ...
        <div className={`${isOpen ? "block p-10 border-t lg:border-none lg:p-0" : "hidden"} lg:block lg:flex-grow`}>
          ...
          <div className="mt-4 flex justify-between">
            <h3 className="font-extrabold font-genos text-3xl text-white mb-2">Camping area:</h3>
            <p className="text-white font-genos text-2xl">{campingSelection.area || "Choose area"}</p>
          </div>
        </div>
        ...
        <div className={`font-genos  text-white p-10 lg:mt-auto lg:pt-4 ${isOpen ? "block" : "border-t lg:border-none"}`}>
          ...
          <p className="text-xl">Booking fee: 99,-*</p>
        </div>
      </div>
    </div>
  );
